...
> 当前版本面向 **DeepSeek Harness 0.1.0-rc.8**。DSH 仍处于开发预览阶段，升级 DSH 前请先查看兼容性说明。
...
仓库提供了公开版 `veang-workbench-install` Skill。它会从 npm 安装并验证 DSH 0.1.0-rc.8 与 Veang Workbench，不包含会话、设置、项目、凭据、桌面端外壳或私人迁移数据。
